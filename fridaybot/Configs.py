...
if ENV:
    ...
    class Config(object):
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/kisalkawshika-ctrl/VirtualUserbot"
        )
        ALIVE_IMAGE = os.environ.get(
            "ALIVE_IMAGE", "https://telegra.ph/file/af819fad38708f8cbe378.jpg"
        )
        ASSISTANT_START_PIC = os.environ.get(
            "ASSISTANT_START_PIC",
            "https://telegra.ph/file/af819fad38708f8cbe378.jpg",
        )
